...
<p align="center">
  ...
  <a href="worker/"><img src="https://img.shields.io/badge/Claude_Code-CLI-cc785c?logo=anthropic&logoColor=white" alt="Claude Code"/></a>
...
| `CLAUDE_CODE_OAUTH_TOKEN` | - | OAuth token (Pro/Max plan) |
...
Fill in **one** of `ANTHROPIC_API_KEY` or `CLAUDE_CODE_OAUTH_TOKEN`.
...
│   ├── run-job.sh         #   Hooks + claude execution
│   └── parse-job.js       #   JSON → shell variables
├── profiles/              # Agent profiles (TOML)
├── templates/             # Jinja2 templates (prompts, CLAUDE.md)
...
- [ ] **Multi-engine worker images** - Dockerfiles for OpenCode
