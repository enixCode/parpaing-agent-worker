...
**Prompt variables**: `repo_url` (required, default: `"https://github.com/org/repo"`), `focus` (default: `"security, performance"`), `branch` (default: `"main"`), `test_command` (default: `"npm test || pytest || go test ./..."`)
